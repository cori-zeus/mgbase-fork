...
CreateClientConVar("mgbase_fx_vm_fov", "1", true, true, "Change viewmodel FOV.", 0.1, 2)
CreateClientConVar("mgbase_fx_vm_pos_x", "0", true, true, "Modify viewmodel offset X", -8, 8)
CreateClientConVar("mgbase_fx_vm_pos_y", "0", true, true, "Modify viewmodel offset Y", -8, 8)
CreateClientConVar("mgbase_fx_vm_pos_z", "0", true, true, "Modify viewmodel offset Z", -8, 8)
CreateClientConVar("mgbase_fx_vm_pos_ads_affected", "0", true, true, "Toggle viewmodel offset taking effect whilst aiming down sights.", 0, 1)
